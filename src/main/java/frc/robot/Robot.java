...
import frc.lib.subsystems.vision.VisionEnvironmentSimulator;
  ...
  public void robotInit() {
    ...
    switch (Constants.MODE) {
      case REAL -> {
        ...
        new PowerDistribution(Constants.HardwareMap.PDH_ID, PowerDistribution.ModuleType.kRev); // Enables power distribution logging
      }
      case SIM -> {
