...
/**
 * A class used to simulate a vision environment based on the PhotonVision VisionSystemSim
 * This includes the cameras, their simulated properties and also the april tags located around the field
 */
