...
/**
 * Implementation of a REV swerve module using a SPARK Flex controller for the drive motor.
 */
public class SparkFlexSwerveModuleIO extends RevSwerveModuleIO {


    /**
     * Creates a new REV swerve module using a SPARK Flex controller for the drive motor.
     *
     ...
     */
    public SparkFlexSwerveModuleIO(int driveId,
                                   int turnId,
                                   PIDFGains drivePID,
                                   PIDFGains turnPID,
    ...
    protected CANSparkBase setTurnMotor(int id) {
        return new CANSparkMax(id, CANSparkBase.MotorType.kBrushless);
    }
}