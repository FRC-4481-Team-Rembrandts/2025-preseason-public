package frc.lib.hardware.constants;

/**
 * The GearRatios class provides easy access to gear ratios of common COTS gearboxes.
 * Some vendors such as REV Robotics sell gearboxes with multiple reduction options.
 * The ratios posted on these products might differ from the actual ratios.
 * This class provides the actual ratios for these gearboxes.
 */
public final class GearRatios {
    ...
    public static class RevRobotics {
         ...
         * UltraPlanetary gearboxes come with 3, 4, and 5 to 1 reduction cartridges.
         * The UltraPlanetary system is compatible with the NEO 550 brushless motor.
         */
        ...
        /**
         * The MaxPlanetary class provides the actual reductions for the REV Robotics MAXPlanetary system.
         * MAXPlanetary gearboxes come with 3, 4, 5 and 9 to 1 reduction cartridges.
         * The MAXPlanetary system is compatible with the NEO and NEO Vortex, Falcon 500 and Kraken X60 brushless motors.
         * Unlike the UltraPlanetary system, the MAXPlanetary system has exact gear ratios as advertised.
         * Therefore, this class only exists for clarity purposes.
         */
        ...
        public static class MaxSwerve {
            ...
            /**
             * The exact gear reduction of the NEO 550 turn motor on the MAXSwerve.
             * The turn rotation of the wheel is also called azimuth.
             */
    ...
    /**
     * The WestCoastProducts class provides the gear reductions for swerve modules sold by WestCoast Products.
     */
    public static class WestCoastProducts {
        // TODO implement SwerveX gear ratios
    }
}
