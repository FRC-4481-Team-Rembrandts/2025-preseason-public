...
/**
 * Class for representing colors in RGB and HSV color modes. Allows for quick conversion between the two modes. All
 * values are in ranges supported by the WPILib {@code AddressableLED} class. RGB values are in the range [0-255]. HSV
 * values are in the range [0-180), [0-255], [0-255]. Intended to be used with {@code PWMLEDController} and
 * {@code LEDStrip} classes.
 *
 * @see <a href="https://en.wikipedia.org/wiki/HSL_and_HSV">HSV on Wikipedia</a>
 * @see edu.wpi.first.wpilibj.AddressableLED
 * @see frc.lib.hardware.lighting.PWMLEDController
...
public class Color {
    ...
    /**
     * Represents a color in HSV. With hue in the range [0-180), saturation in the range [0-255], and value in the range
     * [0-255].
     */
    ...
    public boolean equals(Object obj) {
        ...
        return this.rgb.red == other.rgb.red && this.rgb.green == other.rgb.green && this.rgb.blue == other.rgb.blue;
    }
}
