...
public class SecondOrderSwerveDriveKinematics extends NthOrderSwerveDriveKinematics {
    ...
    public SecondOrderSwerveModuleState[] toSwerveModuleStates(ChassisState chassisState, Rotation2d robotAngle) {
        ...
        SwerveModuleState[] firstOrderResults = super.toSwerveModuleStates(chassisState.toChassisSpeeds());
        ...
        for (int i = 0; i < nModules; i++) {
            ...
            double a_mx = fieldRelativeChassisState.ax
                    - moduleLoc.getX() * chassisState.omegaRadiansPerSecond * chassisState.omegaRadiansPerSecond
                    - moduleLoc.getY() * chassisState.alpha;
            double a_my = fieldRelativeChassisState.ay
                    - moduleLoc.getY() * chassisState.omegaRadiansPerSecond * chassisState.omegaRadiansPerSecond
                    + moduleLoc.getX() * chassisState.alpha;
